                    ...
                    if(mom1_sq){
                        for(int i = -twoJ1; i <= twoJ1; i = i+2){
                            for(int j = -twoJ1; j <= twoJ1; j = j+2){
                                ...
                                D1 += conj(Hadron::Wigner_D(twoJ1, i, two_abs_lam1, r1[0], r1[1], r1[2])) * Ph::comp_Wigner_d(twoJ1, i, j, r1[0], r1[1], r1[2], r_mom1[0], r_mom1[1], r_mom1[2], 2) * Hadron::Wigner_D(twoJ1,  j, two_abs_lam1, r_mom1[0], r_mom1[1], r_mom1[2]);
                            }
                        }
                    }
                    else{D2 = 1;}
                    ...
                    if(mom2_sq){
                        for(int i = -twoJ2; i <= twoJ2; i = i+2){
                            for(int j = -twoJ2; j <= twoJ2; j = j+2){
                                ...
                                D2 += conj(Hadron::Wigner_D(twoJ2, i, two_abs_lam2, r_n_mom2[0], r_n_mom2[1], r_n_mom2[2])) *  Ph::comp_Wigner_d(twoJ2, i, j, r1[0], r1[1], r1[2], r_mom1[0], r_mom1[1], r_mom1[2], 2) * Hadron::Wigner_D(twoJ2,  j, two_abs_lam2, r_mom2[0], r_mom2[1], r_mom2[2]);
                            }
                        }
                    }
                    ...
                    if(mom_curr_sq){
                        for(int i = -twoJCurr; i <= twoJCurr; i = i+2){
                            for(int j = -twoJCurr; j <= twoJCurr; j = j+2){
                                ...
                                DCurr += conj(Hadron::Wigner_D(twoJCurr, i, two_abs_lamCurr, r_n_mom_curr[0], r_n_mom_curr[1], r_n_mom_curr[2])) *  Ph::comp_Wigner_d(twoJCurr, i, j, r1[0], r1[1], r1[2], r_mom1[0], r_mom1[1], r_mom1[2], 2) * Hadron::Wigner_D(twoJCurr,  j, two_abs_lamCurr, r_mom_curr[0], r_mom_curr[1], r_mom_curr[2]);
                            }
